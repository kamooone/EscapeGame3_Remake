...
void C_Enemy::EnemyDraw(int i, float x, float y, float tu[], float tv[], LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
...
void C_Enemy::AppleDraw(int i, float x, float y, LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
...
void C_Enemy::HPGageDraw(int i, float x, float y, int damage, LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
...
void C_Enemy::ShadowDraw(int i, float x, float y, LPDIRECT3DDEVICE9 dev)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
