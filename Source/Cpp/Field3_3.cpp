...
// 初期化処理
//==============================================================================
void C_Field3_3::Init(LPDIRECT3DDEVICE9 dev)
{
	...
	//マップデータファイル読み込み
	error = fopen_s(&f, "External_File/field3_3.csv", "r");
...
// マップ更新処理
//==============================================================================
void C_Field3_3::UpdateProcess()
{
	field_sound = C_Game_Manager::Get_Field_Sound();
	if (field_sound == true)
	{
		C_Sound::StopSound(SOUND_LABEL_BGM001);
		C_Sound::PlaySound(SOUND_LABEL_BGM000);
		C_Game_Manager::Store_Field_Sound(field_sound = false);
	}
...
// マップ描画処理
//==============================================================================
void C_Field3_3::DrawProcess(LPDIRECT3DDEVICE9 dev)
{
	//カラー値取得
