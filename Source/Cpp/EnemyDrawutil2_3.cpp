...
void C_Enemy2_3::EnemyDraw(int i, float x, float y, float tu[], float tv[], LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
...
void C_Enemy2_3::AppleDraw(int i, float x, float y, LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
...
void C_Enemy2_3::HPGageDraw(int i, float x, float y, int damage, LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
...
void C_Enemy2_3::ShadowDraw(int i, float x, float y, LPDIRECT3DDEVICE9 dev)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
	...
	Vertex[0].x = pos_x[i] - ENEMY_WIDTH / 2 + 6.0f + x;
	Vertex[0].y = pos_y[i] - ENEMY_HIGHT + 60.0f + y;
	Vertex[0].z = 0.0f;
	Vertex[0].u = 0.0f;
	Vertex[0].v = 0.0f;

	Vertex[1].x = pos_x[i] + ENEMY_WIDTH / 2 - 8.0f + x;
	Vertex[1].y = pos_y[i] - ENEMY_HIGHT + 60.0f + y;
	Vertex[1].z = 0.0f;
	Vertex[1].u = 1.0f;
	Vertex[1].v = 0.0f;

	Vertex[2].x = pos_x[i] - ENEMY_WIDTH / 2 + 6.0f + x;
	Vertex[2].y = pos_y[i] - ENEMY_HIGHT + 85.0f + y;
	Vertex[2].z = 0.0f;
	Vertex[2].u = 0.0f;
	Vertex[2].v = 1.0f;

	Vertex[3].x = pos_x[i] + ENEMY_WIDTH / 2 - 8.0f + x;
	Vertex[3].y = pos_y[i] - ENEMY_HIGHT + 85.0f + y;
	Vertex[3].z = 0.0f;
	Vertex[3].u = 1.0f;
	Vertex[3].v = 1.0f;
