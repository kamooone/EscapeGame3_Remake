...
// 静的メンバ変数実体化
//*****************************************************************************
float C_Enemy2_3::pos_x[ENEMY_MAX2_3] = { ENEMY2_1_INIT_POS_X2_3, ENEMY2_2_INIT_POS_X2_3, ENEMY2_3_INIT_POS_X2_3, ENEMY2_4_INIT_POS_X2_3 , ENEMY2_5_INIT_POS_X2_3,
ENEMY2_6_INIT_POS_X2_3, ENEMY2_7_INIT_POS_X2_3, ENEMY2_8_INIT_POS_X2_3, ENEMY2_9_INIT_POS_X2_3, ENEMY2_10_INIT_POS_X2_3,
ENEMY2_11_INIT_POS_X2_3 , ENEMY2_12_INIT_POS_X2_3 , ENEMY2_13_INIT_POS_X2_3 , ENEMY2_14_INIT_POS_X2_3 , ENEMY2_15_INIT_POS_X2_3};


float C_Enemy2_3::pos_y[ENEMY_MAX2_3] = { ENEMY2_1_INIT_POS_Y2_3, ENEMY2_2_INIT_POS_Y2_3, ENEMY2_3_INIT_POS_Y2_3, ENEMY2_4_INIT_POS_Y2_3 , ENEMY2_5_INIT_POS_Y2_3,
ENEMY2_6_INIT_POS_Y2_3, ENEMY2_7_INIT_POS_Y2_3, ENEMY2_8_INIT_POS_Y2_3, ENEMY2_9_INIT_POS_Y2_3, ENEMY2_10_INIT_POS_Y2_3,
ENEMY2_11_INIT_POS_Y2_3, ENEMY2_12_INIT_POS_Y2_3, ENEMY2_13_INIT_POS_Y2_3, ENEMY2_14_INIT_POS_Y2_3, ENEMY2_15_INIT_POS_Y2_3};

//エネミーーの向き変数を実体化
int C_Enemy2_3::direction_no_enemy[ENEMY_MAX2_3] = { 0 };

//エネミーの生存状態
int C_Enemy2_3::enemy_state[ENEMY_MAX2_3] = { 0 };

//エネミー被ダメージ数実体化
int C_Enemy2_3::damage[ENEMY_MAX2_3] = { 0 };

//エネミーダメージエフェクトフラグ
bool C_Enemy2_3::damage_flag[ENEMY_MAX2_3] = { false };
...
// 初期化処理
//==============================================================================
void C_Enemy2_3::Init(LPDIRECT3DDEVICE9 dev)
{
...
// プレイヤー追従処理処理
//==============================================================================
void C_Enemy2_3::MoveTuizyu(int i)
{
	//プレイヤーの座標を取得
...
// 右追従処理
//==============================================================================
void C_Enemy2_3::TuizyuRight(int i, float Get_Player_Pos_x, float Get_Player_Pos_y, float scroll_x, float scroll_y)
{
...
// 左追従処理
//==============================================================================
void C_Enemy2_3::TuizyuLeft(int i, float Get_Player_Pos_x, float Get_Player_Pos_y, float scroll_x, float scroll_y)
{
	if (Get_Player_Pos_x - scroll_x - pos_x[i] <= 0 && Get_Player_Pos_x - scroll_x - pos_x[i] >= -150 &&
		Get_Player_Pos_y - scroll_y - pos_y[i] >= -150 && Get_Player_Pos_y - scroll_y - pos_y[i] <= 150)
	{
...
// 上追従処理
//==============================================================================
void C_Enemy2_3::TuizyuUp(int i, float Get_Player_Pos_x, float Get_Player_Pos_y, float scroll_x, float scroll_y)
{
...
// 下追従処理
//==============================================================================
void C_Enemy2_3::TuizyuDown(int i, float Get_Player_Pos_x, float Get_Player_Pos_y, float scroll_x, float scroll_y)
{
	if (Get_Player_Pos_y - scroll_y - pos_y[i] >= 0 && Get_Player_Pos_y - scroll_y - pos_y[i] <= 150 &&
		Get_Player_Pos_x - scroll_x - pos_x[i] >= -150 && Get_Player_Pos_x - scroll_x - pos_x[i] <= 150)
	{
...
// エネミー下移動処理
//==============================================================================
void C_Enemy2_3::MoveDown(int i)
{
	pos_y[i] += 1.0f;
...
// エネミー左移動処理
//==============================================================================
void C_Enemy2_3::MoveLeft(int i)
{
	pos_x[i] -= 1.0f;
...
// エネミー右移動処理
//==============================================================================
void C_Enemy2_3::MoveRight(int i)
{
	pos_x[i] += 1.0f;
...
// エネミー描画処理
//==============================================================================
void C_Enemy2_3::DrawProcess(LPDIRECT3DDEVICE9 dev)
{
	//色情報取得
	...
	for (int i = 0; i < ENEMY_MAX2_3; i++)
	{
		...
		if (enemy_state[i] == 0)
		{
			...
			if (i < 10)
			{
				EnemyDraw(i, C_Game_Manager::scroll_x, C_Game_Manager::scroll_y, g_uvTable_Enemy2_3[uvtblidx_Enemy[i]].u, g_uvTable_Enemy2_3[uvtblidx_Enemy[i]].v,
					dev, t_enemy);
			}
			else if (i < 20)
			{
		...
		if (enemy_state[i] == 1)
		{
			...
			HPGageDraw(i, C_Game_Manager::scroll_x, C_Game_Manager::scroll_y, 0, dev, t_red_hp_gage);
			HPGageDraw(i, C_Game_Manager::scroll_x, C_Game_Manager::scroll_y, damage[i], dev, t_yellow_hp_gage);
			EnemyDraw(i, C_Game_Manager::scroll_x, C_Game_Manager::scroll_y, g_uvTable_Explosion2_3[uvtblidx_Explosion[i]].u, g_uvTable_Explosion2_3[uvtblidx_Explosion[i]].v,
				dev, t_explosion);
		}
		//リンゴ描画
		if (enemy_state[i] == 2)
...
// エネミーアニメーション処理
//==============================================================================
void C_Enemy2_3::Enemy_Animation(LPDIRECT3DDEVICE9 dev)
{
	//uvtbl(エネミー)初期化
	for (int i = 0; i<ENEMY_MAX2_3; i++)
	{
		uvtblidx_Enemy[i] = g_anim_Enemy2_3[animtblidx_Enemy[i]].no;
	}
...
// 爆発アニメーション処理
//==============================================================================
void C_Enemy2_3::Explosion_Animation(LPDIRECT3DDEVICE9 dev)
{
	//uvtbl(爆発)初期化
	for (int i = 0; i<ENEMY_MAX2_3; i++)
	{
		uvtblidx_Explosion[i] = g_anim_Explosion2_3[animtblidx_Explosion[i]].no;
	}
