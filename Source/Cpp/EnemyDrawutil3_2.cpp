...
void C_Enemy3_2::EnemyDraw(int i, float x, float y, float tu[], float tv[], LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
...
void C_Enemy3_2::AppleDraw(int i, float x, float y, LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
...
void C_Enemy3_2::HPGageDraw(int i, float x, float y, int damage, LPDIRECT3DDEVICE9 dev, LPDIRECT3DTEXTURE9 tex)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
...
void C_Enemy3_2::ShadowDraw(int i, float x, float y, LPDIRECT3DDEVICE9 dev)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
