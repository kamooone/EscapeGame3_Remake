...
// 初期化処理
//==============================================================================
void C_Field2_1::Init(LPDIRECT3DDEVICE9 dev)
{
	...
	//マップデータファイル読み込み
	error = fopen_s(&f, "External_File/field2_1.csv", "r");
...
// マップ描画処理
//==============================================================================
void C_Field2_1::DrawProcess(LPDIRECT3DDEVICE9 dev)
{
