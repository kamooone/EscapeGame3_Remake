...
void C_Field2_2::Field1Draw_Process(LPDIRECT3DDEVICE9 dev)
{
	for (int i = 0; i < 1000; i += 20)
	{
		...
		{
			//地面描画
			if (MapData_No2_TwoDim[i / 20][j / 20] == 1 || MapData_No2_TwoDim[i / 20][j / 20] == -99 || MapData_No2_TwoDim[i / 20][j / 20] == 9 || MapData_No2_TwoDim[i / 20][j / 20] == 5)
			{
				Ground1Draw((float)j + scroll_x, (float)i + scroll_y, dev);
			}

			//木の下の地面
			if (MapData_No2_TwoDim[i / 20][j / 20] == 2
				|| MapData_No2_TwoDim[i / 20][j / 20] == -2 || MapData_No2_TwoDim[i / 20][j / 20] == -20 || MapData_No2_TwoDim[i / 20][j / 20] == 3 || MapData_No2_TwoDim[i / 20][j / 20] == -90)
			{
			...
			if (MapData_No2_TwoDim[i / 20][j / 20] == -5 || MapData_No2_TwoDim[i / 20][j / 20] == -102
				 || MapData_No2_TwoDim[i / 20][j / 20] == -101 || MapData_No2_TwoDim[i / 20][j / 20] == -98
