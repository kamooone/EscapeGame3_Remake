...
// 初期化処理
//==============================================================================
void C_Field2_3::Init(LPDIRECT3DDEVICE9 dev)
{
	...
	//マップデータファイル読み込み
	error = fopen_s(&f, "External_File/field2_3.csv", "r");
...
// マップ描画処理
//==============================================================================
void C_Field2_3::DrawProcess(LPDIRECT3DDEVICE9 dev)
{
	//カラー値取得
