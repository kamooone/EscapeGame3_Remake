...
// 初期化処理
//==============================================================================
void C_Field1::Init(LPDIRECT3DDEVICE9 dev)
{
	...
	//マップデータファイル読み込み
	error = fopen_s(&f, "External_File/field1.csv", "r");
...
// マップ描画処理
//==============================================================================
void C_Field1::DrawProcess(LPDIRECT3DDEVICE9 dev)
{
	//カラー値取得
