...
void C_Field2_3::Field1Draw_Process(LPDIRECT3DDEVICE9 dev)
{
	for (int i = 0; i < 1000; i += 20)
	{
		for (int j = 0; j < 1200; j += 20)
		{
			...
			//木の下の地面
			if (MapData_No2_TwoDim[i / 20][j / 20] == -2 || MapData_No2_TwoDim[i / 20][j / 20] == -20 || MapData_No2_TwoDim[i / 20][j / 20] == 2
				|| MapData_No2_TwoDim[i / 20][j / 20] == -90 || MapData_No2_TwoDim[i / 20][j / 20] == 3)
			{
