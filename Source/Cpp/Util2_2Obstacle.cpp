...
void C_Field2_2::Tree1Draw(float i, float j, LPDIRECT3DDEVICE9 dev)
{
...
void C_Field2_2::TosenboDraw(float i, float j, LPDIRECT3DDEVICE9 dev)
{
	VERTEX_2DTEX Vertex[4];			// 頂点座標
